...
import { ExtraComment } from '../store/reducers/commentReducer';
//import { notificationTypes } from '../store/reducers/notificationReducer';
import { ExtraPost, LIMIT_POSTS_PER_LOADING, Post, PostAction, postActionTypes, PostErrorAction, PostList, PostSuccessAction } from '../store/reducers/postReducer';
import { HashTag, UserInfo } from '../store/reducers/userReducer';
...
export const FetchPostListRequest = ():
    ThunkAction<Promise<void>, {}, {}, PostAction> => {
        console.log('FetchPostListRequest');
