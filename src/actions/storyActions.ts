...
import { ExtraStory, seenTypes, Story, StoryAction, storyActionTypes, StoryErrorAction, StoryList, StorySuccessAction } from '../store/reducers/storyReducer';
import { HashTag, UserInfo, StoryArchive } from '../store/reducers/userReducer';
