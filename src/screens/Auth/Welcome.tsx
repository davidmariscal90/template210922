...
import { RegisterFormValuesStep1 } from './Register'

export type WelcomePropsRouteParams = RegisterFormValuesStep1
            ...
            <View style={styles.centerContainer}>
                <View>
                    <Text style={{
                        fontWeight: '600',
                        textAlign: 'center'
                    }}>{chagingUsername ? 'CHANGE USERNAME' : 'WELCOME TO APP,'} </Text>
